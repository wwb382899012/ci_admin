...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
		...
		<select name="type">
			...
			?>
			<option value="<?php echo ($info['type'] == $ckey)?'selected':'' ; ?>"><?php echo $cval ; ?></option>
			<?php } ?>
		</select>
		</td>
    </tr>
    <tr>
        ...
        <td><input type="text" id="url" name="url" placeholder="跳转地址"  value="<?php echo $info['url'];?>"/>备注:如果类型是跳转请填写地址</td>
    </tr>	
     <tr>
